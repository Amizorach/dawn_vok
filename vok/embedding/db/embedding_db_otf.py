...
class EmbeddingDBOTF(EmbeddingDB):
    def __init__(self, table_id, generator_id=None, db_name=None, latent_dim=32, seed=42, device="cpu"):
        super().__init__(table_id, generator_id, latent_dim, "otf", db_name)
    ...
    def to_dict(self):
        ...
        # ret["search_matrix"] = self.search_matrix
        # ret["search_device"] = self.search_device
        ret["seed"] = self.seed
        return ret
